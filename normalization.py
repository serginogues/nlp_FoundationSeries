...
"""
from config import STAGE, combinations, tqdm
from utils import is_name
import collections
import math


def normalize_list(entity_list):
    ...
    if STAGE == 1:
        ...
        normalized = [['Star', 'Far Star'],
                      ['Fran', 'Flan'],
                      ['Senter', 'Lee Senter', 'Lee'],
                      ['Semic', 'Elvett Semic', 'Elvett'],
                      ['Asper Argo', 'Asper', 'Argo'],
                      ['Commason', 'Commissioner', 'Commissioners'],
                      ['Privy Secretary', 'Secretary'],
                      ['Channis', 'Bail Channis'],
                      ['Pritcher', 'Twice Pritcher'],
                      ['Grand Master', 'Master'],
                      ['Second Foundation', 'Foundation'],
                      ['Lieutenant Dirige', 'Dirige'],
                      ['Linge Chen', 'Chen'],
                      ['Flober Mallow', 'Mallow', 'Hober Mallow'],
                      ['Forell', 'Sennett Forell', 'Korell'],
                      ['Ebling Mis', 'Mis'],
                      ['Capsule', 'Personal Capsule'],
                      ['Hardin', 'Salvor', 'Salvor Hardin'],
                      ['Fara', 'Far Star'],
                      ['Elders'],
                      ['Bayta'],
                      ['Transmitter'],
